...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "gdA4kAQFpI2TX4uyjodz3GMCB5g16ZKX";

	public List<Item> search(double lat, double lon, String keyword) {
		if (keyword == null) {
			keyword = DEFAULT_KEYWORD;
		}
		// keyword can have special char(s), we have to encode it first
		try {
		...
		// "apikey=YOUR_KEY&latlong=37,-120&keyword=event&radius=50"
		...
		try {
			...
			// use isNull() to judge whether "_embedded" key exist in JSONObject
